  ...
  return (
    ...
    <div className=' bg-gray-200 py-5 px-5 md:px-12 lg:px-28'>
        ...
        <div className=" flex justify-between items-center">
            ...
            <button
            className=' flex items-center gap-2 font-medium py-1 px-3 sm:py-3 sm:px-6 border border-black shadow-[-7px_7px_0px_#000]'
            >
                Get Started
    ...
    <div className=" mx-5 max-w-[800px] md:mx-auto mt-[-100px] mb-10">
        ...
        <Image src={data.image} width={1280} height={720}
        ...
        <p className=' my-3'>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsa ratione tempore eum dignissimos laudantium autem earum cum pariatur sunt magni repudiandae illum corrupti, hic iusto ex sed id facere ad?
        </p>
